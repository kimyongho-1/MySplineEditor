...
{
    public class ColorEffect : IUI_Effect
    {
        public event Action<IUI_Effect> _OnCompleted;
        YieldInstruction _wait { get; }
        float _changeSpeed { get; }
        private Color _baseColor { get; } // 기본 컬러색상
        private Color _onPointerColor { get; } // 커서 다가갔을떄
        private Color _onHighlightColor { get; } // 눌리거나 데미지를 받거나할떄
        private Image _image { get; }  // 기본 이미지
